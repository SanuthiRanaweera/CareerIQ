            ...
            child: SingleChildScrollView(
              ...
              child: ConstrainedBox(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.stretch, children: [
                  const Icon(Icons.explore_rounded, size: 58, color: Color(0xFF0B6E69)),
                  const SizedBox(height: 18),
                  Text('Welcome back', style: Theme.of(context).textTheme.headlineMedium?.copyWith(fontWeight: FontWeight.bold)),
                  const SizedBox(height: 8),
                  Text('Continue building your career path.', style: Theme.of(context).textTheme.bodyLarge),
                  ...
                  if (_error != null) ...[const SizedBox(height: 14), Text(_error!, style: TextStyle(color: Colors.red))],
                  const SizedBox(height: 24),
                  FilledButton(onPressed: _loading ? null : _submit, child: _loading ? const CircularProgressIndicator() : const Text('Log in')),
                  const SizedBox(height: 12),
                  TextButton(onPressed: widget.onRegister, child: const Text('Create a student account')),
                ]),
              ),
            ),
          ),
